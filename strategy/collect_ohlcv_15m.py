...
print(f"{symbol} 15분봉 {lookback_days}일치 데이터 수집 시작...")
...
while fetch_time < end_time:
    ...
    fetch_time = datetime.fromtimestamp(last_open_time) + timedelta(minutes=15)
    time.sleep(0.2)
...
save_path = 'ohlcv_BTCUSDT_15m_180d.csv'
